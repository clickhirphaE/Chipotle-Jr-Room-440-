...
public class week_2chiptolechallenge {
    ...
    public static void main(String args[]) {
     ...
     do{
         ...
         Queso_index=rand.nextInt(Queso.size());
         sour_index=rand.nextInt(Sour_cream.size());
         System.out.println(" Burrito " + i + ":[" + Rice.get(rice_index) + "," + Meat.get(Meat_index) + "," + Beans.get(Beans_index) + "," + Salsa.get(Salsa_index) + "," + veggies.get(veggies_index) + "," + cheese.get(cheese_index) + "," + Guac.get(Guac_index) + "," + Queso.get(Queso_index) + "," + Sour_cream.get(sour_index)+" ]");
         y++;
        }while (y<=25);
